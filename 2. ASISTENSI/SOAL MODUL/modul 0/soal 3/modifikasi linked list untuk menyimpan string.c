...
void slist_pushFront(SinglyList *list, char data[MAX_STR]);
void slist_popFront(SinglyList *list);
void slist_pushBack(SinglyList *list, char value[MAX_STR]);
void slist_popBack(SinglyList *list);
void slist_insertAt(SinglyList *list, int index, char value[MAX_STR]);
void slist_removeAt(SinglyList *list, int index);
void slist_remove(SinglyList *list, char value[MAX_STR]);
...
void slist_pushFront(SinglyList *list, char value[MAX_STR]) 
{
...
int main(int argc, char const *argv[])
{
    ...
    slist_pushBack(&myList, "bismillah");
    slist_pushBack(&myList, "alhamdulillah");
//    slist_pushBack(&myList, 4);

//    slist_pushFront(&myList, "yok");
    slist_pushFront(&myList, "laa haulaa walaa quwwata illaa billah");
    slist_pushFront(&myList, "masya Allah");
//    slist_pushFront(&myList, 7);

    while (myList._head != NULL) {
        printf("%s ", slist_back(&myList));
        slist_popBack(&myList); //ini harus pakai slist_popback ya mbak?
    }
